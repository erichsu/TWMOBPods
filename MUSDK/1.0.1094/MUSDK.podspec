#
#  Be sure to run `pod spec lint MUSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Eric Hsu"
  # s.authors            = { "Eric Hsu" => "eric_hsu@livemail.tw" }
  # s.social_media_url   = "http://twitter.com/Eric Hsu"
  ...
  s.source       = { :http => "http://twmob.azurewebsites.net/MUSDK/MUSDK-1.0.1094.zip", :flatten => true }
